...
import static com.wjdgus262.ocrtestapplication.Main2Activity.sTess;
public class CameraView extends Activity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(pathActivity.subdata == null)
        {
            number = Main2Activity.numberCheck;
        }else if(Main2Activity.numberCheck == null)
        {
            number = String.valueOf(pathActivity.subnum);
        }
    ...
    private class AsyncTess extends AsyncTask<Bitmap, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            //완료 후 버튼 속성 변경 및 결과 출력
                ...
                if (sTess.getUTF8Text().equals(number)) {
                    Toast.makeText(getApplicationContext(), getString(R.string.get), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), getString(R.string.not), Toast.LENGTH_SHORT).show();
                }




            Toast.makeText(getApplicationContext(),sTess.getUTF8Text(),Toast.LENGTH_SHORT).show();
            mBtnOcrStart.setEnabled(true);
